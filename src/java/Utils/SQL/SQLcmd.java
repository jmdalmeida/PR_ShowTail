...
public enum SQLcmd {
    ...
    Account_user_data,Account_validate_username, Account_validate_email, Account_followed_shows, Account_check_login, Account_create_user, Account_update_user, Account_delete_user,
