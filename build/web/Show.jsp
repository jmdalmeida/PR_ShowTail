...
try {
    Object[] o2 = {idSeason};
    ResultSet hi2 = jdbc.select("select * from season where ID_Season = ?;", o2);
    while(hi2.next()) {
        season_number = Integer.parseInt(hi2.getString("Season_Number"));
    }
    ResultSet hi3 = jdbc.select("select * from episode where ID_Season = ?;", o2);
    while(hi3.next()) {
        ...
        <div id="summary">
            ...
            <div id="short">
                <p id="texts<%= n %>-short"> 
                    ...
                    <%if(!less) { %>
                    <a href="#" id="texts-show" onclick="showHide('texts<%=n%>');return false;">
                        Read More >>
                    </a>
                    <%} %>    
                </p>
                    ...
                    <div id="open">
                        <p id="texts<%= n%>-complete">
                            ...
                            <a href="#" id="texts-hide" 
                               onclick="showHide('texts<%= n%>');return false;"> << Read Less</a>
                        </p>
                    </div>
                </div>
            </div>
